<div x-data="{ open: @entangle('isOpen') }" class="relative">
    <button @click="open = !open" class="px-4 py-2 bg-gray-200 rounded-md">
        Open Command Menu
    </button>
    ...
    <div x-show="open" 
         ...
         class="absolute mt-2 w-64 bg-white rounded-md shadow-lg">
        <div class="p-2">
            <input type="text" wire:model.debounce.300ms="search" placeholder="Search..." class="w-full px-3 py-2 border rounded-md mb-2">
            <ul>
